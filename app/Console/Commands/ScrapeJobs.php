...
{
    protected $signature = 'job:scrape {alert_id?}'; 

    protected $description = 'Scrape jobs for all active alerts or specific alert';
    ...
    public function handle(): int
    {
        ...
        if($alertId){
            ...
            foreach($alerts as $alert){
                $this->info("Dispatching scrape job for #{$alert->id} ({$alert->keyword})");
                ScrapeJobsForAlert::dispatch($alert);
            }
